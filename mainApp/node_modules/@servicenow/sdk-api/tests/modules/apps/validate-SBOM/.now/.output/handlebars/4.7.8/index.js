...
function noop$1() {}
var console = global$1.console ? global$1.console : {
    log: noop$1,
    info: noop$1,
    warn: noop$1,
    error: noop$1,
 ...
 */ function createNewLookupObject() {
    ...
    return _utils$4.extend.apply(undefined, [
        Object.create(null)
    ].concat(sources));
}
	    ...
	    var parser = {
	        ...
	        parse: function parse(input) {
	            var self = this, stack = [
	                ...
	                null
	            ], lstack = [], table = this.table, yytext = "", yylineno = 0, yyleng = 0;
...
(function (module, exports) {
	...
	try {
	    /* istanbul ignore next */ if (typeof undefined !== 'function' || !undefined.amd) {
...
/* istanbul ignore else */ if (typeof commonjsRequire !== 'undefined' && commonjsRequire.extensions) {
