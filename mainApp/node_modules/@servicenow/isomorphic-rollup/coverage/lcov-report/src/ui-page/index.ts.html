...
<head>
    <title>Code coverage report for src/ui-page/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ui-page</a> index.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        for (const scriptEl of scriptElements) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!src) <span class="cstat-no" title="statement not covered" >continue;</span>
          ...
          if (await fileExists(fullPathWithoutQueryParams)) {
...
&nbsp;
        for (const [name, { scriptEl }] of entryElements.entries()) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!originalSrc) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
