...
<head>
    <title>Code coverage report for src/rollup/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/rollup</a> index.ts</h1>
        <div class='clearfix'>
...
const invokeRollup = (options: RollupOptions): Promise&lt;RollupBuild&gt; =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isBrowserOrWorkerEnvironment()) {
    let plugins: InputPluginOption = <span class="cstat-no" title="statement not covered" >[];</span>
...
<span class="cstat-no" title="statement not covered" >      plugins = options.plugins;</span>
    } else <span class="cstat-no" title="statement not covered" >if (options.plugins) {</span>
<span class="cstat-no" title="statement not covered" >      plugins = [options.plugins];</span>
    }
<span class="cstat-no" title="statement not covered" >    plugins.push(webFsLoader());</span>
  }
&nbsp;
  return bareRollup({
    ...options,
...
&nbsp;
export { <span class="fstat-no" title="function not covered" >defineConfig,</span> <span class="fstat-no" title="function not covered" >VERSION </span>} from "rollup";
&nbsp;</pre></td></tr></table></pre>
