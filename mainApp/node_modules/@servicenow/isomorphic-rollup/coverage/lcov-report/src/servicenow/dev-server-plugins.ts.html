...
<head>
    <title>Code coverage report for src/servicenow/dev-server-plugins.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/servicenow</a> dev-server-plugins.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Credential } from "./types";
&nbsp;
/**
...
&nbsp;
  ...
  try {
    ...
    devServer = imported.default || <span class="branch-1 cbranch-no" title="branch not covered" >imported;</span>
  } catch (error: any) {
    throw new Error(
      `rollup-plugin-dev is not installed or failed to load. Please install it to enable the dev server.${error.message ? ` Original error: ${error.message}` : <span class="branch-1 cbranch-no" title="branch not covered" >""}</span>`,
    );
  }
  let livereload: any;
  try {
    const imported = await import("rollup-plugin-livereload");
    livereload = imported.default || <span class="branch-1 cbranch-no" title="branch not covered" >imported;</span>
  } catch (error: any) {
    throw new Error(
      `rollup-plugin-livereload is not installed or failed to load. Please install it to enable the dev server.${error.message ? ` Original error: ${error.message}` : <span class="branch-1 cbranch-no" title="branch not covered" >""}</span>`,
    );
  }
  return [
    devServer({
