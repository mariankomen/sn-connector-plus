...
<head>
    <title>Code coverage report for src/ui-page-source-manifest/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ui-page-source-manifest</a> index.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type { Plugin, OutputBundle, OutputChunk } from "rollup";
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!entryName) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!entryToSources.has(entryName)) {
          entryToSources.set(entryName, new Set());
        }
&nbsp;
        const sources = entryToSources.get(entryName)!;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!entryToEntryPoint.has(entryName) &amp;&amp; chunk.facadeModuleId) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (chunk.modules) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (fileName.endsWith(".html")) {
...
&nbsp;
        for (const [entryName, sources] of entryToSources.entries()) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (entryBasename === htmlName || htmlFiles.length === 1) {
...
&nbsp;
        ...
        for (const entryName of entries) {
          const sources = entryToSources.get(entryName);
          <span class="missing-if-branch" title="else path not taken" >E</span>if (sources) {
...
&nbsp;
        ...
        const entryPoint = entryToEntryPoint.get(firstEntryName) || <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
&nbsp;
