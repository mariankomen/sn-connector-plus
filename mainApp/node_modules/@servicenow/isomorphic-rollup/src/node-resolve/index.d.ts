...
export interface RollupNodeResolveOptions {
   ...
   * resolving entry-point imports, and when resolving deduplicated modules. Defaults to process.cwd()
   *
   */
  rootDir?: string;
  ...
  /**
   * The filesystem implementation to use when resolving paths.
   */
  fs?: IsomorphicRollupFs;

  /**
   * Whether imports & exports on the target package.json should be validated. This will allow resolution of files that are
   * not present in the package.json#exports.
   * @default true
   */
  validateImportsExports?: boolean;

  /**
   * Ignore export mappings of the target dependency's package.json (use classic node resolution)
   * @default false
   */
