...
/**
 * SLA Definition table - defines Service Level Agreements for task records.
 * Used to track response and resolution times against defined schedules.
 */
export const contract_sla = Table({
    ...
    schema: {
        ...
        adv_condition_type: StringColumn({
            active: false,
            default: 'none',
            choices: {
                advanced_system: {
                ...
                advanced_journal: {
                    label: 'Has advanced with Journal',
                    sequence: 3,
                },
            },
        ...
        cancel_condition: ConditionsColumn({
            attributes: {
                readable: true,
            },
        ...
        condition_class: ReferenceColumn({
            attributes: {
                encode_utf8: false,
            },
        ...
        duration_type: ReferenceColumn({
            attributes: {
                encode_utf8: false,
            },
            choices: {
                NULL_OVERRIDE: {
                    label: 'User specified duration',
                },
            },
            dropdown: 'dropdown_with_none',
            label: [
        ...
        pause_condition: ConditionsColumn({
            attributes: {
                readable: true,
            },
            dependent: 'collection',
        ...
        reset_action: StringColumn({
            default: 'cancel',
            choices: {
                complete: {
                    label: 'Complete existing Task SLA',
                    sequence: 2,
                },
                cancel: {
                    label: 'Cancel existing Task SLA',
                    sequence: 1,
                },
            },
            dropdown: 'dropdown_without_none',
        ...
        reset_condition: ConditionsColumn({
            attributes: {
        ...
        resume_condition: ConditionsColumn({
            attributes: {
                readable: true,
            },
            dependent: 'collection',
        ...
        retroactive_pause: BooleanColumn({
            default: true,
            label: [
                {
        ...
        schedule_source_field: FieldNameColumn({
            attributes: {
        ...
        set_start_to: FieldNameColumn({
            attributes: {
                types: 'glide_date_time',
            },
            dependent: 'collection',
            label: [
                {
        ...
        start_condition: ConditionsColumn({
            attributes: {
                readable: true,
            },
            dependent: 'collection',
        ...
        stop_condition: ConditionsColumn({
            attributes: {
                readable: true,
            },
            dependent: 'collection',
        ...
        when_to_cancel: StringColumn({
            default: 'on_condition',
            choices: {
                no_match: {
                    label: 'Start conditions are not met',
                    sequence: 1,
                },
                on_condition: {
                    label: 'Cancel conditions are met',
                    sequence: 2,
                },
                never: {
                    label: 'Never',
        ...
        when_to_resume: StringColumn({
            default: 'on_condition',
            choices: {
                no_match: {
                    label: 'Pause conditions are not met',
                    sequence: 1,
                },
                on_condition: {
                    label: 'Resume conditions are met',
                    sequence: 2,
                },
            },
            dropdown: 'dropdown_without_none',
