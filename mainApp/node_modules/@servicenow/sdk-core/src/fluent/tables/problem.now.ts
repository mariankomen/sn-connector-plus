...
export const problem = Table({
    ...
    schema: {
        ...
        confirmed_at: DateTimeColumn({
            label: 'Confirmed',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        fix_by: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        fix_at: DateTimeColumn({
            label: 'Fix',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        primary_known_error_article: ReferenceColumn({
            attributes: {
                encode_utf8: false,
        ...
        fix_communicated_at: DateTimeColumn({
        ...
        workaround_communicated_at: DateTimeColumn({
            label: 'Workaround communicated',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        fix_communicated_by: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        first_reported_by_task: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        cause_notes: HtmlColumn({
            label: 'Cause notes',
        }),
        related_incidents: IntegerColumn({
            default: '0',
            label: [
                {
        ...
        workaround_applied: BooleanColumn({
            default: false,
        ...
        workaround_communicated_by: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        workaround: HtmlColumn({
            label: 'Workaround',
        }),
        fix_notes: HtmlColumn({
            label: 'Fix notes',
        }),
    },
    textIndex: true,
