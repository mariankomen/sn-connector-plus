...
export const sys_script_vtable = Table({
    ...
    schema: {
        cache_isolation_level: ChoiceColumn({
            default: 'USER',
        ...
        cache_empty_query_results: BooleanColumn({
            default: true,
        ...
        enhanced_capacity: BooleanColumn({
            default: false,
