...
export const sys_ui_list_control = Table({
    ...
    label: 'List Control',
    name: 'sys_ui_list_control',
    schema: {
        omit_related_list_count: BooleanColumn({
            label: [
                {
        ...
        hierarchical_lists: BooleanColumn({
            label: [
                {
        ...
        omit_count_views_list: ListColumn({
            attributes: {
                array: 'denormalized',
                no_sort: true,
        ...
        edit_default_filter: ConditionsColumn({
            label: 'Edit default filter',
        }),
        omit_columns_if_empty: BooleanColumn({
            label: [
                {
        ...
        columns_condition: GenericColumn({
            columnType: 'script_plain',
            label: [
                {
        ...
        filter_condition: GenericColumn({
            columnType: 'script_plain',
            label: [
                {
        ...
        omit_count_views: BooleanColumn({
            label: [
                {
        ...
        list_edit_insert_row: BooleanColumn({
            default: false,
            label: [
                {
        ...
        omit_edit_button: BooleanColumn({
            default: true,
            label: [
                {
        ...
        omit_drilldown_link: BooleanColumn({
            label: [
                {
        ...
        list_edit_type: StringColumn({
            choices: {
                save_by_row: {
                    label: 'Save data by rows',
                    sequence: 2,
                },
                NULL_OVERRIDE: {
        ...
        list_edit_ref_qual_tag: StringColumn({
            label: [
                {
