type ScriptActionOptions = Now.Internal.WithID<
    {
        /**
 ...
 * Consider using a function exported from your `src/server` modules or using `Now.include()` to move the script to a separate js file
 * @param options An Object containing the properties of the Script Action
 *
 * See {@link https://www.servicenow.com/docs/csh?topicname=fluent-script-action-api.html&version=latest} for more details
 */
export function ScriptAction(options: ScriptActionOptions): Parameters<typeof ScriptAction>[0] {
    return options
}
