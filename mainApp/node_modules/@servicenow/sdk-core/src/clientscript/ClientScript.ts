...
type field_type<T extends TableName, E> = E extends Exclude<client_script_events, 'onSubmit' | 'onLoad' | '--None--'>
    ? keyof FullSchema<T> | (string & {})
    : never
 ...
 */
export function ClientScript<T extends TableName, E extends client_script_events, G extends boolean = true>(
    properties: ClientScriptProps<T, E, G>
) {
    return properties
}
