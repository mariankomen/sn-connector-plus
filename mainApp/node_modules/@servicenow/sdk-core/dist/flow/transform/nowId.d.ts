 ...
 * ```
 */
export type WithNowId<F extends (...args: any[]) => any> = F extends (...args: infer P) => infer R ? (context: Now.Internal.WithID<{
    annotation?: string;
}>, ...args: P) => R : never;
/**
