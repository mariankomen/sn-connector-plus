 ...
 */
type DateFormat = 'dd-MM-yyyy' | 'yyyy-MM-dd' | 'yyyy-dd-MM' | 'MM-dd-yyyy HH:mm:ss z' | 'yyyy-MM-dd HH:mm:ss' | 'HH:mm:ss' | 'MM-dd-yyyy HH:mm:ss' | 'dd-MM-yyyy HH:mm:ss z' | 'MM-dd-yyyy' | 'dd-MM-yyyy HH:mm:ss';
/**
 ...
 */
type ScriptTiming = 'onBefore' | 'onAfter' | 'onReject' | 'onStart' | 'onForeignInsert' | 'onComplete' | 'onChoiceCreate';
/**
...
type ImportSetType = {
     ...
     */
    fields?: {
        [targetField: string]: string | ImportSetFieldValue;
    };
 ...
 *
 * **/
export declare function ImportSet(config: ImportSet): ImportSet;
export {};
