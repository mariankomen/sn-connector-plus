...
type UserPreference = Now.Internal.WithID<UserPreferenceType & Now.Internal.Meta>;
/**
 ...
 */
export declare function UserPreference(config: UserPreference): UserPreference;
export {};
