...
} & Now.Internal.Meta & addMessage & abortAction & filterCondition & roleConditions & setFieldValue & protectionPolicy>;
/**
 ...
 * ```
 */
export declare function BusinessRule<const T extends TableName>(config: BusinessRule<T>): BusinessRule<T>;
export {};
