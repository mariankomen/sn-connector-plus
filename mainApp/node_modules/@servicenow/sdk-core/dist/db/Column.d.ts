...
export declare const readOnlyOption: readonly ["instance_configured", "display_read_only", "client_script_modifiable", "strict_read_only"];
export type readOnlyOptionType = (typeof readOnlyOption)[number];
export type Documentation = {
    ...
    url?: string;
    urlTarget?: string;
    /** @deprecated use urlTarget instead */
    url_target?: never;
} | {
    hint?: string;
    help?: string;
...
export type Column<Type = unknown, Default extends Type = Type> = Typed<Type, {
    ...
    /** @deprecated Use tableReference instead */
    table_reference?: never;
    /** @deprecated Use elementReference instead */
    element_reference?: never;
    /** @deprecated Use spellCheck instead */
    spell_check?: never;
    /** @deprecated Use xmlView instead */
    xml_view?: never;
