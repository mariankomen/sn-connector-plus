...
type MandatoryColumns<T extends TableName> = Required<FilterIn<FullSchema<T>, {
    mandatory: true;
}>>;
export type Data<T extends TableName> = {
    [C in keyof (Partial<FullSchema<T>> & MandatoryColumns<T>)]: C extends keyof FullSchema<T> ? TypeOf<FullSchema<T>[C]> : never;
};
 ...
 */
export declare function Record<const T extends TableName, const R extends Record<T>>(record: R & Record<T>): R;
export {};
