 ...
 */
export declare function VariableSet<const V extends VariableTypes>(config: VariableSetConfig<V> & {
    variables: V;
}): VariableSetConfig<V> & {
    variables: V;
};
export declare function VariableSet(config: VariableSetConfig): VariableSetConfig;
export {};
