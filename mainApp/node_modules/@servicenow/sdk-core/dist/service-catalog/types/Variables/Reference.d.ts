 ...
 */
export type ReferenceVariableType<RefTable extends TableName = TableName, Type extends Record<RefTable> | Now.Internal.ExplicitKey | string = Record<RefTable> | Now.Internal.ExplicitKey | string> = VariableConfig<Type> & {
 ...
 */
export declare function ReferenceVariable(config: ReferenceVariableType): ReferenceVariableType<keyof Now.Internal.Tables, string | Now.Internal.ExplicitKey<string> | Record<keyof Now.Internal.Tables>>;
