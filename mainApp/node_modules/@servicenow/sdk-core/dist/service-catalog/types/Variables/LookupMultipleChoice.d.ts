...
import type { LookupVariableBaseType } from './LookupBase';
/**
 * Configuration type for lookup multiple choice variables
 */
export type LookupMultipleChoiceVariableType<RefTable extends TableName = TableName, Type extends Record<RefTable> | Now.Internal.ExplicitKey | string = Record<RefTable> | Now.Internal.ExplicitKey | string> = LookupVariableBaseType<RefTable, Type>;
/**
 * A Variable for a lookup multiple choice field.
 *
 * @see https://docs.servicenow.com/csh?topicname=variable-types.html&version=latest
 *
 * @param config - Configuration for the lookup multiple choice variable including:
 ...
 */
export declare function LookupMultipleChoiceVariable(config: LookupMultipleChoiceVariableType): LookupMultipleChoiceVariableType<keyof Now.Internal.Tables, string | Now.Internal.ExplicitKey<string> | Record<keyof Now.Internal.Tables>>;
