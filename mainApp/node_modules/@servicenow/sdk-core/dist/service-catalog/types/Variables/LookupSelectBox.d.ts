...
/**
 * Configuration type for lookup select box variables
 */
export type LookupSelectBoxVariableType<RefTable extends TableName = TableName, Type extends Record<RefTable> | Now.Internal.ExplicitKey | string = Record<RefTable> | Now.Internal.ExplicitKey | string> = LookupVariableBaseType<RefTable, Type>;
/**
 * A Variable for a lookup select box field.
 *
 * @see https://docs.servicenow.com/csh?topicname=variable-types.html&version=latest
 *
 * @param config - Configuration for the lookup select box variable including:
 ...
 */
export declare function LookupSelectBoxVariable(config: LookupSelectBoxVariableType): LookupSelectBoxVariableType<keyof Now.Internal.Tables, string | Now.Internal.ExplicitKey<string> | Record<keyof Now.Internal.Tables>>;
