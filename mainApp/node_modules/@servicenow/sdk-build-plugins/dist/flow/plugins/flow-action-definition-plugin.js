    ...
    shapes: [
        {
            ...
            async toRecord(callExpression, { factory, diagnostics }) {
                ...
                if (outputsConfig) {
                    const { variableRecords: outputRecords, complexObjectRecords: outputComplexObjects } = await (0, flow_io_to_record_1.buildVariableRecords)({
...
//# sourceMappingURL=flow-action-definition-plugin.js.map