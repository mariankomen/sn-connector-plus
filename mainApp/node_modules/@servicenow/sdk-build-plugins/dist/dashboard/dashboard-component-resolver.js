...
exports.resolveComponentToSysId = resolveComponentToSysId;
exports.resolveComponentToName = resolveComponentToName;
/**
 * Mapping of human-readable component names (kebab-case) to their sys_ids
 */
const COMPONENT_NAME_TO_SYSID = {
 ...
 */
const COMPONENT_SYSID_TO_NAME = Object.fromEntries(Object.entries(COMPONENT_NAME_TO_SYSID).map(([name, sysid]) => [sysid, name]));
/**
 ...
 */
function resolveComponentToSysId(component) {
 ...
 */
function resolveComponentToName(sysid) {
    return COMPONENT_SYSID_TO_NAME[sysid] || sysid;
}
//# sourceMappingURL=dashboard-component-resolver.js.map