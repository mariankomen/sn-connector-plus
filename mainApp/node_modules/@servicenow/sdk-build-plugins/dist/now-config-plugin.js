...
exports.NowConfigPlugin = exports.NowConfigShape = void 0;
const sdk_build_core_1 = require("@servicenow/sdk-build-core");
const json_plugin_1 = require("./json-plugin");
...
exports.NowConfigPlugin = sdk_build_core_1.Plugin.create({
                    ...
                    value: new NowConfigShape({
                        ...
                        properties: record.transform(({ $ }) => ({
                            ...
                            accessControls: $.from('scoped_administration', 'restrict_table_access', 'can_edit_in_studio', 'runtime_access_tracking', 'private', 'trackable', 'uninstall_blocked', 'hide_on_ui', 'user_role')
                                ...
                                .map((scoped_administration, restrict_table_access, can_edit_in_studio, runtime_access_tracking, p, trackable, uninstall_blocked, hide_on_ui, user_role) => ({
                                ...
                                runtimeAccessTracking: runtime_access_tracking.toString().getValue() === ''
                                    ? 'none'
                            ...
                            licensing: $.from('licensable', 'enforce_license', 'license_model', 'subscription_entitlement', 'license_category')
                                .def({
                                licensable: true,
                                enforceLicense: 'log',
                                licenseModel: 'none',
                                ...
                                .map((licensable, enforce_license, license_model, subscription_entitlement, license_category) => ({
                            ...
                            packageResolverVersion: $.from('package_resolver_version').def(config.scope === 'global' ? sdk_build_core_1.MODULE_RESOLUTION.V2 : sdk_build_core_1.MODULE_RESOLUTION.V1),
                        })),
                    }),
                };
            },
    ...
    shapes: [
        {
            shape: json_plugin_1.JsonFileShape,
            async toRecord(file, { factory, config: rawConfig, packageJson, diagnostics }) {
                if (file.getBaseName() !== sdk_build_core_1.NowConfig.FILE_NAME) {
                    return { success: false };
                }
                if (rawConfig.type === 'configuration') {
                    return { success: false };
                }
                const config = sdk_build_core_1.Shape.from(file.getJson(), rawConfig).asObject();
                ...
                let packageJsonPath;
                try {
                    packageJsonPath = sdk_build_core_1.NowConfig.moduleResolutionPath(rawConfig, packageJson, false, 'package.json');
                }
                catch (e) {
...
//# sourceMappingURL=now-config-plugin.js.map