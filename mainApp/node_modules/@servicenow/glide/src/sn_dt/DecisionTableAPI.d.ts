...
export declare class DecisionTableAPI {
  ...
  findOrCreateMultipleAnswerRecord(
    decisionId?: string,
    answerElementValues?: Record<any, any>
  ): string;
  findOrCreateMultipleAnswerRecords(
    decisionId?: string,
    answerElementValuesMap?: Record<any, any>
  ): Record<any, any>;
